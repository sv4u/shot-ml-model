...
```{r testing_data}
kable(analysis.2018[1:25,], caption = "Regular Season Shot Data from the 2018-2019 Season")
```
...
```{r nnet_data}
kable(nnet.prediction.data[1:25,], caption = "Neural Network Prediction Data")
```

Our K-Nearest Neighbors data looks like:

```{r knn_data}
kable(knn.prediction.data[1:25,], caption = "K-Nearest Neighbors Data")
```
